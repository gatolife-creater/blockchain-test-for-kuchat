...
const testchain1 = new Blockchain();
const testchain2 = new Blockchain();

let sign = ec.genKeyPair();
let fromAddress = sign.getPublic('hex');
let toAddress = 'testTo';

testchain1.minePendingTransactions(fromAddress);

let transaction = new Transaction(fromAddress, toAddress, 100, '殺すぞ');
transaction.signTransaction(sign);

testchain1.addTransaction(transaction);

console.log(testchain1);
